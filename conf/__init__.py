...
# Openware Tests
openware_api_key = os.getenv("OPENWARE_API_KEY")
openware_api_secret = os.getenv("OPENWARE_API_SECRET")
openware_api_url = os.getenv("https://stage.trakx.io/api/v2/peatio")
openware_ranger_url = os.getenv("wss://stage.trakx.io/api/v2/ranger")
...
try:
    from .openware_secret import *           # noqa: F401, F403
except ModuleNotFoundError:
    pass
