...
cdef class PureMarketMakingStrategyV2(StrategyBase):
    ...
    def __init__(self,
                 ...
                 include_matching_orders: bool = False):
        ...
        self._include_matching_orders = include_matching_orders
    ...
    cdef object c_filter_orders_proposal_for_takers(self, object market_info, object orders_proposal):
        ...
        if orders_proposal.buy_order_sizes[0] > 0:
            ...
            for i in range(0, len(orders_proposal.buy_order_prices)):
                if first_ask.is_nan() or self._include_matching_orders or (orders_proposal.buy_order_prices[i] < first_ask):
        ...
        if orders_proposal.sell_order_sizes[0] > 0:
            ...
            for i in range(0, len(orders_proposal.sell_order_prices)):
                if first_bid.is_nan() or self._include_matching_orders or (orders_proposal.sell_order_prices[i] > first_bid):
